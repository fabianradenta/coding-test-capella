        ...
        {STATUS_TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`inline-flex h-11 items-center gap-2 rounded-lg border px-4 text-sm font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-800 ${
                active
      ...
      <div className="ml-auto flex flex-wrap items-center gap-3">
        <div className="relative">
          ...
          <input
            ...
            className="h-11 w-72 max-w-full rounded-lg border border-slate-300 bg-white pr-3 pl-9 text-base text-slate-900 placeholder:text-slate-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-800"
          />
        </div>
        ...
        <select
          ...
          className="h-11 rounded-lg border border-slate-300 bg-white px-3 text-base text-slate-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-800"
        >
